...
public class FusionBootstrap : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    private Vector3 GetSpawnPointion(PlayerRef player)
    {
    ...
    public void OnPlayerJoined(NetworkRunner runner, PlayerRef player) 
    {
        ...
        Vector3 spawnPos = GetSpawnPointion(player);
    ...
    public void OnInput(NetworkRunner runner, NetworkInput input) 
    {
        ...
        buttons.Set((int)InputButton.Fire, Input.GetMouseButtonDown(0));         // 마우스 버튼
